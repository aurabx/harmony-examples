...
This example demonstrates the JMIX endpoint with performance optimization flags for handling large datasets efficiently. This example is ideal for:

- Building high-performance JMIX packaging pipelines
- Retrieving and packaging DICOM studies efficiently
- Optimizing data transfer for healthcare systems
- Managing large DICOM datasets
...
3. Configure DICOM backend target and performance options
