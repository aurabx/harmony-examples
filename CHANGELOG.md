...
- Legacy to FHIR pipeline example for converting legacy data to FHIR format
- Webhook to FHIR pipeline example for webhook-driven FHIR transformation

### Changed
- Renamed some of the examples for clarity
- Cleaned up tags

## [0.11.0]
### Added
- DICOM to AI example pipeline for AI integration workflows
- Data Mesh example demonstrating distributed data architecture patterns
- HTTP File Upload example for handling file upload scenarios
- HTTP with Middleware example showcasing middleware chain patterns
- DICOM to JMIX pipeline example for healthcare data packaging
- JMIX Backend pipeline example for JMIX processing workflows
